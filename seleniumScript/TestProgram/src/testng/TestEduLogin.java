...
public class TestEduLogin {
	...
	@Test()
	public void teacher_apply() throws Exception{
//	System.setProperty("Webdriver.firefox.bin", "C:\\Program Files (x86)\\Mozilla Firefox\\firefox.exe");
		driver = new FirefoxDriver();
		driver.get("http://passport.csdn.net/account/login?from=http://testedu.csdn.net//course");
		Thread.sleep(2000);
		driver.findElement(By.id("username")).clear();
		driver.findElement(By.id("username")).sendKeys("csto_funds");
		driver.findElement(By.id("password")).clear();
		driver.findElement(By.id("password")).sendKeys("miaoyan1989");
		driver.findElement(By.xpath("//*[@id='fm1']/input[6]")).click();
		driver.findElement(By.linkText("首页")).click();
//		验证是否成功登录在线培训，登录进去之后页面是否包含“大叔范_123字样”
		Assert.assertTrue(driver.findElement(By.className("name")).getText().contains("大叔范_123"));
		driver.findElement(By.linkText("讲师")).click();
		driver.findElement(By.linkText("讲师申请")).click();
